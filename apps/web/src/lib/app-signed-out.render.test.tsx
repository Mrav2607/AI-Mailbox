...
const mockApi = vi.hoisted(() => {
  ...
  return {
    ...
    listLlmCredentials: vi.fn(notImplemented),
    createLlmCredential: vi.fn(notImplemented),
    activateLlmCredential: vi.fn(notImplemented),
    deleteLlmCredential: vi.fn(notImplemented),
